...
export function Icon({
  ...
  if (name === "Bolt" || name === "Command") return <svg aria-hidden="true" className={`icon ${className}`} width={size} height={size} viewBox="3 4 13 13" fill="currentColor">
    <path d="M4.55 9.1 14.1 5.25q.85-.34.54.55l-3.57 9.6q-.32.85-.78-.02V9.72H4.7q-.92-.03-.15-.62Z" />
  </svg>;
